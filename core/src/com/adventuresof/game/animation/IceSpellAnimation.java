...
/**
 * Extends the spell animation class to create an IceSpellAnimation. 
 * Contains the data specific to the IceSpellAnimation 
 */
public class IceSpellAnimation extends SpellAnimation{

	// texture sheets
	private static final String MOVEMENT_UP_SPRITE_SHEET = "spells//iceSpell.png";
	private static final String MOVEMENT_DOWN_SPRITE_SHEET = "spells//iceSpell.png";
	private static final String MOVEMENT_LEFT_SPRITE_SHEET = "spells//iceSpell.png";
	private static final String MOVEMENT_RIGHT_SPRITE_SHEET = "spells//iceSpell.png";
