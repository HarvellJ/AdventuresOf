...
public class Phoenix extends NPC {
	...
	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//phoenix.png";
	private static final String DEATH_SPRITE_SHEET = "characters//phoenix.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//phoenix.png";
	...
	public Phoenix(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				...
				new CharacterAnimation(MOVEMENT_SPRITE_SHEET, COMBAT_SPRITE_SHEET, DEATH_SPRITE_SHEET,
						...
						), MovementSpeedEnum.NORMAL_MEDIUM, name, isTalkative, conversation, CharacterClass.mage, CharacterLevel.high);
