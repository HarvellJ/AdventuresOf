...
public class MeleeKnight extends NPC {

	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//knightSprite.png";
	private static final String DEATH_SPRITE_SHEET = "characters//knightSprite.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//knightSprite.png";
	...
	public MeleeKnight(TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				accessibleTiles,
				startX, 
				startY, 
