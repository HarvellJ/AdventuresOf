...
/**
 * A class to represent the Magic Merchant character.
 * 
 */
public class MagicMerchant extends NPC {

	// texture sheets
		private static final String MOVEMENT_SPRITE_SHEET = "characters//magicmerchant.png";
		private static final String DEATH_SPRITE_SHEET = "characters//magicmerchant.png";
		private static final String COMBAT_SPRITE_SHEET = "characters//magicmerchant.png";
	...
	public MagicMerchant(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, 
