...
/**
 * A class to represent the HellHound character.
 * 
 */
public class HellHound extends NPC {

	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//hellHound.png";
	private static final String DEATH_SPRITE_SHEET = "characters//hellHound.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//hellHound.png";
	...
	public HellHound(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				gameWorld,
				accessibleTiles,
				startX, 
				...
				new CharacterAnimation(MOVEMENT_SPRITE_SHEET, COMBAT_SPRITE_SHEET, DEATH_SPRITE_SHEET,
						...
						), MovementSpeed.NORMAL_MEDIUM, name, isTalkative, conversation, CharacterClass.jungleZoneNPC_Mage, CharacterLevel.low);
