...
public class Horse extends NPC {
	...
	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//goldHorse.png";
	private static final String DEATH_SPRITE_SHEET = "characters//goldHorse.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//goldHorse.png";

	// texture sheet sizes
	private static final int MOVEMENT_SPRITE_SHEET_COLS = 6;
	private static final int MOVEMENT_SPRITE_SHEET_ROWS = 4;
	private static final int DEATH_SPRITE_SHEET_COLS = 6;
	private static final int DEATH_SPRITE_SHEET_ROWS = 4;
	private static final int COMBAT_SPRITE_SHEET_COLS = 6;
	private static final int COMBAT_SPRITE_SHEET_ROWS = 4;
	// movement values
	private static final int MOVE_LEFT_START_FRAME = 6;
	private static final int MOVE_LEFT_FRAMES = 5;
	private static final int MOVE_RIGHT_START_FRAME = 18;
	private static final int MOVE_RIGHT_FRAMES = 5;
	private static final int MOVE_DOWN_START_FRAME = 12;
	private static final int MOVE_DOWN_FRAMES = 5;
	private static final int MOVE_UP_START_FRAME = 0;
	private static final int MOVE_UP_FRAMES = 5;

	// idle values
	private static final int IDLE_LEFT_START_FRAME = 6;
	private static final int IDLE_RIGHT_START_FRAME = 18;
	private static final int IDLE_DOWN_START_FRAME = 12;
	private static final int IDLE_UP_START_FRAME = 0;

	// combat values
	private static final int ATTACK_LEFT_START_FRAME = 0;
	private static final int ATTCK_LEFT_FRAMES = 0;
	private static final int ATTACK_RIGHT_START_FRAME = 0;
	private static final int ATTACK_RIGHT_FRAMES = 0;
	private static final int ATTACK_DOWN_START_FRAME = 0;
	private static final int ATTACK_DOWN_FRAMES = 0;
	private static final int ATTACK_UP_START_FRAME = 0;
	private static final int ATTACK_UP_FRAMES = 0;

	// death values
	private static final int DEATH_ANIMATION_START_FRAME = 0;
	private static final int DEATH_ANIMATION_FRAMES = 3;

	public Horse(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				gameWorld,
				accessibleTiles,
				startX, 
