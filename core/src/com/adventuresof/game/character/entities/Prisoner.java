...
/**
 * A class to represent the Prisoner character.
 * 
 */
public class Prisoner extends NPC{

	// texture sheets
		private static final String MOVEMENT_SPRITE_SHEET = "characters//prisoner.png";
		private static final String DEATH_SPRITE_SHEET = "characters//prisoner.png";
		private static final String COMBAT_SPRITE_SHEET = "characters//prisoner.png";
	...
	public Prisoner(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, 
