...
/**
 * A class to represent the Knight character.
 * 
 */
public class Knight extends NPC {
	...
	private static final String DEATH_SPRITE_SHEET = "characters//darkknight.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//darkknight.png";
	...
	public Knight(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				gameWorld,
				accessibleTiles,
				startX, 
				...
				new CharacterAnimation(MOVEMENT_SPRITE_SHEET, COMBAT_SPRITE_SHEET, DEATH_SPRITE_SHEET,
						...
						), MovementSpeed.NORMAL_MEDIUM, name, isTalkative, conversation, CharacterClass.melee, CharacterLevel.low);
