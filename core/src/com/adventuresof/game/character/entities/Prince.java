...
/**
 * A class to represent the Prince character.
 * 
 */
public class Prince extends NPC{

	// texture sheets
		private static final String MOVEMENT_SPRITE_SHEET = "characters//prince.png";
		private static final String DEATH_SPRITE_SHEET = "characters//prince.png";
		private static final String COMBAT_SPRITE_SHEET = "characters//prince.png";
	...
	public Prince(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, 
