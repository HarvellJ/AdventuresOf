...
/**
 * A class to represent the Gold Knight character.
 * 
 */
public class KnightGold extends NPC {

	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//knightGoldTrim.png";
	private static final String DEATH_SPRITE_SHEET = "characters//knightGoldTrim.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//knightGoldTrim.png";
