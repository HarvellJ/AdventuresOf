...
public class OldMage extends NPC {

	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//mageSprite.png";
	private static final String DEATH_SPRITE_SHEET = "characters//mageSprite.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//mageSprite.png";
	...
	public OldMage(TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				accessibleTiles,
				startX, 
				startY, 
