...
public class LavaCastleGuard extends NPC{
	...
	public LavaCastleGuard(TiledMapTileLayer accessibleTiles, float startX, float startY, String name, 
		...
		super(
				...
				new CharacterAnimation(MOVEMENT_SPRITE_SHEET, COMBAT_SPRITE_SHEET, DEATH_SPRITE_SHEET,
						...
						), CharacterSpeed.NORMAL_MEDIUM, name, isTalkative, conversation, hasQuest, questName);
	}	
}
