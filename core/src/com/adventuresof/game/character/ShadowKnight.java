...
public class ShadowKnight extends NPC {

	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//shadowKnight.png";
	private static final String DEATH_SPRITE_SHEET = "characters//shadowKnight.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//shadowKnight.png";
	...
	public ShadowKnight(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isStatic) {
		super(  
				gameWorld,
				accessibleTiles,
				startX, 
