...
public class PlayerCompanion extends NPC {
	...
	public PlayerCompanion(TiledMapTileLayer accessibleTiles, GameCharacter characterToFollow, String name) {
		super(accessibleTiles, "animation_sheet.png", 8, 5, 1700, 1300, false, false, 50, 50, false, null, name);
