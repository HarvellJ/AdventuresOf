...
public class HorseKnight extends NPC {
	...
	public HorseKnight(TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				accessibleTiles,
				startX, 
				startY, 
