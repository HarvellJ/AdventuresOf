...
public class HorseKnight extends NPC {
	...
	// texture sheets
	private static final String MOVEMENT_SPRITE_SHEET = "characters//horseKnight.png";
	private static final String DEATH_SPRITE_SHEET = "characters//horseKnight.png";
	private static final String COMBAT_SPRITE_SHEET = "characters//horseKnight.png";
	...
	public HorseKnight(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, boolean isTalkative, ArrayList<String> conversation, boolean isHostile) {
		super(
				gameWorld,
				accessibleTiles,
				startX, 
